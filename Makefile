...
SRC = ./lib/queue.c \
	./lib/tinyprintf.c \
	./core/LPC17xx_Interrupts.c \
	./core/system_UBERTOOTH.c \
	./core/LPC17xx_Startup.c \
	./core/fault.c \
	./drivers/lpc17_uart.c \
	./drivers/ubertooth_usb.c \
	./drivers/ubertooth_clock.c \
	./kernel/coreos.c \
	./kernel/kernel.c \
	./kernel/os_utils.c \
	./kernel/tasks.c \
	...
	./app/task_usb.c \
	./app/cmsis_utils.c \
  ./drivers/lpcusb/target/usbinit.c \
  ./drivers/lpcusb/target/usbcontrol.c \
  ./drivers/lpcusb/target/usbstdreq.c \
  ./drivers/lpcusb/target/usbhw_lpc.c

ASRC = core/interrupts.S
...
LDFLAGS += $(patsubst %,-L%,$(LINKER_PATH))
LDFLAGS += -static
...
clean: begin ctags_clean clean_list clean_binary end
...
EXTRAINCDIRS += ./app
EXTRAINCDIRS += ./drivers
EXTRAINCDIRS += ./drivers/lpcusb/target
EXTRAINCDIRS += ./CMSIS
EXTRAINCDIRS += ./core
EXTRAINCDIRS += ./kernel
EXTRAINCDIRS += ./lib
EXTRAINCDIRS += ../../host/libubertooth/src

re: clean all

flash: all
	ubertooth-dfu -d $(TARGET).dfu -r
